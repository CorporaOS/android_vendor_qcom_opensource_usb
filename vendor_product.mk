...
ifneq ($(filter bengal lahaina taro parrot neo anorak blair kalama pineapple monaco pitti niobe volcano anorak61 neo61,$(TARGET_BOARD_PLATFORM)),)
...
ifeq ($(USB_USES_QMAA),true)
  ...
  #
  ifneq ($(filter bengal niobe taro kalama neo parrot anorak pineapple blair monaco pitti volcano anorak61 neo61,$(TARGET_BOARD_PLATFORM)),)
